...
const DoctorBooking = () => {
  ...
  let initialValue = {
    ...
    description: "",
    address: "",
    nameOnCard: "Bác sĩ Nathaniel Homenick",
    cardNumber: "5286434839227308",
    expiredMonth: "06",
    cardExpiredYear: "26",
    cvv: "030",
  };
  ...
  const handleConfirmSchedule = () => {
    ...
    obj.payment = {
      ...
      cvv: "030",
      expiredMonth: "06",
      nameOnCard: "Dr. Nathaniel Homenick",
    };
