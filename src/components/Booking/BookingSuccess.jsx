        ...
        {data?.id ? (
          ...
          >
            <div className="border-bottom my-2">
              ...
              />
              <h6 className="py-2">Cuộc họp đã được sắp xếp</h6>
              ...
              <p className="text-secondary border rounded-pill form-text text-success border-success">
                Vì lý do demo nên web không gửi email, bạn có thể xem chi tiết
                cuộc họp trên web
              </p>
            </div>
            ...
            <div className="card border-0 p-3 rounded mb-5">
              <div className="d-flex gap-3 mb-2 align-items-center">
                ...
                <Link to={`/dashboard/appointments/${id}`}>
                  <h5 className="text-primary">Xem chi tiết cuộc họp</h5>
                </Link>
              </div>
              ...
              <div className="d-flex gap-3 mb-1">
                ...
                <p className="text-start">
                  Bệnh viện My Appointment, Việt Nam
                  <br />
                  <span className="form-text">361/8 Hưng Hòa, Bình Chánh</span>
                </p>
              </div>
              ...
              <div className="d-flex gap-3">
                ...
                <p>
                  {data.scheduleDate &&
                    data.scheduleTime &&
                    moment(data.scheduleDate).format("DD/MM/YYYY") +
                      " " +
                      data.scheduleTime}
                </p>
              </div>
