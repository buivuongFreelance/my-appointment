...
const createAppointment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const first3DigitName = (_b = patientInfo === null || patientInfo === void 0 ? void 0 : patientInfo.firstName) === null || _b === void 0 ? void 0 : _b.slice(0, 3).toUpperCase();
        ...
        (0, emailTransporter_1.EmailtTransporter)({ pathName, replacementObj, toMail, subject });
        return appointment;
    }));
    return result;
});
const createAppointmentByUnAuthenticateUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        patientInfo['trackingId'] = trackingId;
        patientInfo['doctorId'] = config_1.default.defaultAdminDoctor;
        const appointment = yield tx.appointments.create({
            data: patientInfo,
        });
        const { paymentMethod, paymentType } = payment;
